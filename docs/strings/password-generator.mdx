...
- Think about constructing a character set with all character groups the user selected. For example, if the user only wants numbers and special characters your program would **dynamically** create a character set only with numbers and special characters.
